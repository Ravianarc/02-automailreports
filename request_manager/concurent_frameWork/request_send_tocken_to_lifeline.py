...
class RequestSignalToken:
    def __init__(self) -> None:
        mydate = datetime.datetime.now()-datetime.timedelta(1)
        self.today = mydate.strftime("%d-%b-%Y")

    def send_request_signal_token(self,processid,processname,registerby):
        try :
...
if __name__ =='__main__':
    ...
    RequestSignalToken().send_request_signal_token(processid,processname,registerby)